...
import { Shield, Lock, Eye, Mail, ShieldCheck, Globe2 } from 'lucide-react';
          ...
          <aside className="hidden lg:block sticky top-40">
            <MotionWrapper direction="right">
              ...
              <div className="p-8 rounded-3xl bg-[#F8F9FA] md:bg-black/2 border border-black/5 md:backdrop-blur-3xl space-y-6 hover:bg-white hover:shadow-[0_20px_40pxrgba(0,0,0,0.03)] hover:-translate-y-1 transition-all duration-500 cursor-default">
                ...
                <div>
                  <p className="text-2.5 uppercase tracking-[0.2em] font-bold text-brand-accent/80 mb-2">Enterprise Privacy</p>
                  ...
                  <div className="lg:pl-16 space-y-10">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-8 rounded-3xl bg-black/1 border border-black/5 hover:bg-white hover:shadow-[0_20px_40pxrgba(0,0,0,0.04)] hover:-translate-y-2 transition-all duration-500 cursor-pointer group/card">
                        <p className="text-2.5 uppercase tracking-[0.2em] font-bold text-brand-accent/40 mb-6 group-hover/card:text-brand-accent/60 transition-colors">Email Line</p>
