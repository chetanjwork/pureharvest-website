...
import { FileText, Gavel, Scale, Mail, MapPin, ArrowRight, CheckCircle2, ShieldCheck, Globe2 } from 'lucide-react';
          ...
          <aside className="hidden lg:block sticky top-40">
            <MotionWrapper direction="right">
              ...
              <div className="p-8 rounded-[24px] bg-[#F8F9FA] md:bg-black/[0.02] border border-black/5 md:backdrop-blur-3xl space-y-6 hover:bg-white hover:shadow-[0_20px_40px_rgba(0,0,0,0.03)] hover:-translate-y-1 transition-all duration-500 cursor-default">
                ...
                <div>
                  <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-accent/80 mb-2">Certified Governance</p>
                  ...
                  <div className="lg:pl-16 space-y-10">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-8 rounded-[24px] bg-black/[0.01] border border-black/5 hover:bg-white hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] hover:-translate-y-2 transition-all duration-500 cursor-pointer group/card">
                        <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-brand-accent/40 mb-6 group-hover/card:text-brand-accent/60 transition-colors">Communications</p>
                        <p className="text-lg font-bold text-brand-accent/80 mb-2">pureharvestenterprise@gmail.com</p>
                        <p className="text-[10px] font-bold text-brand-accent/40">Secured Legal Line</p>
                      </div>
                      <div className="p-8 rounded-[24px] bg-black/[0.01] border border-black/5 hover:bg-white hover:shadow-[0_20px_40px_rgba(0,0,0,0.04)] hover:-translate-y-2 transition-all duration-500 cursor-pointer group/card">
                        ...
                        <p className="text-[10px] font-bold text-brand-accent/40">India Operations</p>
                      </div>
                    </div>
                  </div>
                </MotionWrapper>
