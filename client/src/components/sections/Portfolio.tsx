      ...
      <Section className="bg-brand-primary text-brand-accent py-16 lg:py-20 overflow-hidden relative" id="portfolio">
        <Container>
          <div className="flex flex-col items-center justify-center min-h-100">
            ...
            <span className="text-2.5 font-black uppercase tracking-[0.25em] text-brand-accent/30">Loading Custom Renders...</span>
          </div>
        </Container>
      </Section>
    );
      ...
      <Container className="relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 sm:mb-16 gap-6 sm:gap-8">
          <div className="text-center md:text-left">
            <span className="text-brand-accent/40 font-black tracking-[0.3em] uppercase text-2.5 mb-3 block">
              Selected Works
            </span>
            <Heading
              level={2}
          ...
          <p className="text-brand-accent/60 max-w-sm font-medium text-sm sm:text-3.75 leading-relaxed text-center md:text-left mx-auto md:mx-0">
        ...
        <div
          ref={stageRef}
          className="relative mx-auto select-none h-95 sm:h-120 lg:h-137.5 w-full"
        ...
        >
          {bottles.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative flex items-center justify-center h-[95%] max-h-120 aspect-2/3">
                  ...
                  <div
                    className="absolute -bottom-0.5 left-1/2 -translate-x-1/2 rounded-full bg-black/10 pointer-events-none z-0"
                    style={{
                  ...
                  <div
                    className="absolute -bottom-2 left-1/2 -translate-x-1/2 rounded-full bg-black/5 pointer-events-none z-0"
                    style={{
                  ...
                  <div
                    className="absolute -bottom-0.75 left-1/2 -translate-x-1/2 rounded-full pointer-events-none z-0"
                    style={{
          ...
          <button
            ...
            className="absolute left-2 sm:-left-8 md:-left-12 top-1/2 -translate-y-1/2 z-40 w-12 h-12 rounded-full bg-white/90 md:bg-white/60 hover:bg-white/95 hover:scale-110 active:scale-95 md:backdrop-blur-md border border-white/80 flex items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all duration-300 group cursor-pointer"
            aria-label="Previous"
          >
          ...
          <button
            ...
            className="absolute right-2 sm:-right-8 md:-right-12 top-1/2 -translate-y-1/2 z-40 w-12 h-12 rounded-full bg-white/90 md:bg-white/60 hover:bg-white/95 hover:scale-110 active:scale-95 md:backdrop-blur-md border border-white/80 flex items-center justify-center shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-all duration-300 group cursor-pointer"
            aria-label="Next"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="group-hover:translate-x-0.5 transition-transform duration-300">
        ...
        <div className="mt-8 sm:mt-12 text-center" style={{ minHeight: 90 }}>
          <AnimatePresence mode="wait">
            ...
            >
              <h2 className="text-[12px] sm:text-[13px] font-semibold uppercase tracking-[0.2em] text-[#0A1128]/40 mb-1.5">
                {bottle.title}
              </h2>
              <p className="text-[24px] sm:text-[28px] lg:text-[32px] font-medium tracking-tight text-[#0A1128] mb-3">
                {bottle.client}
              </p>
