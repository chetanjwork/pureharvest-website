  ...
  return (
    <MotionWrapper className={className} delay={delay}>
      <motion.div
        ...
        className="group p-8 md:p-12 rounded-4xl md:rounded-[40px] bg-linear-to-br from-white to-gray-50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_30px_60pxrgba(0,0,0,0.08)] border border-black/3 transition-all cursor-pointer h-full flex flex-col relative overflow-hidden"
      >
        {/* MAGNETIC GLOW EFFECT */}
        <motion.div
          className="pointer-events-none absolute -inset-px rounded-4xl md:rounded-[40px] opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-0"
          style={{
    ...
    <Section className="bg-brand-primary text-brand-accent" id="services">
      <Container>
        <div className="text-center mb-20">
          <MotionWrapper>
            <span className="text-brand-secondary font-black tracking-[0.3em] uppercase text-2.5 mb-4 block">
              What We Do
            </span>
          </MotionWrapper>
        ...
        {/* BENTO BOX GRID */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[minmax(280px,auto)] lg:auto-rows-80">
          
          {/* BENTO 1: Signature Branding */}
          <BentoCard className="lg:col-span-2 lg:row-span-2" delay={0.1}>
            <div className="absolute -top-32 -right-32 w-96 h-96 bg-linear-to-br from-brand-secondary/10 to-transparent blur-20 rounded-full group-hover:scale-150 transition-transform duration-1000 ease-out z-0" />
            <div className="absolute -right-10 -bottom-10 w-[120%] max-w-125 opacity-[0.03] pointer-events-none group-hover:scale-[1.02] group-hover:-translate-y-2 transition-transform duration-1000 ease-out z-0">
              <Image 
            ...
            <motion.div
              ...
              className="w-16 h-16 bg-linear-to-br from-[#0B2147] to-[#1E3A8A] text-white rounded-2xl flex items-center justify-center mb-8 flex-shrink-0 relative z-10 shadow-[0_10px_30pxrgba(11,33,71,0.2)] border border-white/10"
            >
            ...
            <p className="text-brand-accent/60 leading-relaxed text-4 md:text-4.5 font-medium max-w-sm relative z-10 mt-auto">
          ...
          <BentoCard className="lg:col-span-2 lg:row-span-1" delay={0.2}>
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-center">
              <motion.div
                ...
                className="w-14 h-14 bg-linear-to-br from-gray-100 to-white text-brand-accent rounded-2xl flex items-center justify-center mb-6 flex-shrink-0 shadow-sm border border-black/5"
              >
                <Globe size={24} strokeWidth={2} />
              </motion.div>
              <h3 className="text-2xl md:text-3xl font-black mb-3 text-brand-accent tracking-tight">Global Logistics</h3>
              <p className="text-brand-accent/60 leading-relaxed text-3.75 font-medium max-w-md">
          ...
          <BentoCard className="lg:col-span-1 lg:row-span-1" delay={0.3}>
            <motion.div
              ...
              className="w-14 h-14 bg-linear-to-br from-blue-50 to-blue-100/50 text-[#0066FF] rounded-2xl flex items-center justify-center mb-6 flex-shrink-0 shadow-sm border border-blue-500/10"
            >
            ...
            <p className="text-brand-accent/60 leading-relaxed text-3.5 font-medium mt-auto">
