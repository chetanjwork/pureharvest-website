...
export default function Transformation() {
  return (
    <Section className="bg-black text-white pt-64 pb-32 relative z-20 -mt-px" id="transformation">
      <Container>
        <div className="text-center mb-32 relative z-30">
          <MotionWrapper>
            <span className="text-white/20 font-black tracking-[0.4em] uppercase text-2.5 mb-6 block">The Transformation</span>
            ...
            <TextReveal
              text="Our state-of-the-art purification system doesn&apos;t just filter water&mdash;it transforms it. Experience the perfect balance of purity and essential minerals that elevate your brand&apos;s drinking experience."
              delay={0.2}
        ...
        <div className="grid lg:grid-cols-2 border border-white/10 rounded-4xl md:rounded-[48px] overflow-hidden bg-[#0A0A0A]">
          ...
          <div className="relative group overflow-hidden border-b lg:border-b-0 lg:border-r border-white/10">
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 md:p-12 bg-linear-to-t from-black/80 to-transparent pointer-events-none">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-10 h-px bg-white/20" />
                <span className="text-white/30 text-2.25 uppercase tracking-[0.4em] font-black">Stage 01</span>
              </div>
          ...
          <div className="relative group overflow-hidden">
            ...
            <div className="absolute inset-x-0 bottom-0 p-8 md:p-12 bg-linear-to-t from-black/80 to-transparent pointer-events-none">
              <div className="flex items-center gap-4 mb-4">
                ...
                <span className="text-white text-2.25 uppercase tracking-[0.4em] font-black">Stage 02</span>
              </div>
              <motion.h3 
            ...
            {/* Premium Badge */}
            <div className="absolute top-8 right-8 bg-white text-black px-6 py-2 rounded-full text-2.25 font-black uppercase tracking-widest shadow-2xl">
              100% Impact
            </div>
          </div>
        ...
        <div className="mt-20 text-center">
          <MotionWrapper delay={0.4}>
            <div className="inline-flex flex-col items-center gap-6">
              <div className="h-20 w-px bg-linear-to-b from-white/20 to-transparent" />
              <p className="text-white/20 text-2.5 uppercase tracking-[0.5em] font-black">Transform Your Property Today</p>
            </div>
          </MotionWrapper>
        </div>
      </Container>
