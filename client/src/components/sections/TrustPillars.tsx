      ...
      <Container>
        <div className="flex flex-col lg:flex-row gap-20 items-start">
          <div className="lg:w-1/3 relative lg:sticky lg:top-32 z-10 mb-8 lg:mb-0">
            <MotionWrapper>
              <span className="text-white/20 font-black tracking-[0.4em] uppercase text-2.5 mb-6 block">Why Choose Us</span>
          ...
          <div className="lg:w-2/3 grid gap-6">
            {pillars.map((pillar, i) => (
              <MotionWrapper key={i} delay={i * 0.1} className="group">
                <div className="bg-white/2 border border-white/5 hover:border-white/20 p-8 md:p-12 rounded-4xl transition-all duration-500 hover:bg-white/4">
