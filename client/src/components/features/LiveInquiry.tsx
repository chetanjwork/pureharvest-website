...
export default function LiveInquiry() {
  return (
    <Section className="bg-white py-24 md:py-32 relative overflow-hidden" id="live-inquiry">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-px bg-linear-to-r from-transparent via-black/10 to-transparent" />
      ...
      <Container>
        <motion.div 
          ...
          className="relative z-10 bg-[#F8F9FA] md:bg-black/2 border border-black/5 md:backdrop-blur-md rounded-[48px] px-8 py-16 md:py-20 flex flex-col items-center text-center gap-10 group hover:border-black/10 transition-all duration-500 shadow-sm md:shadow-none"
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full">
            <div className="relative w-full sm:w-auto">
              ...
              <a
                ...
                className="relative w-full sm:w-auto flex items-center justify-center gap-3 bg-[#25D366] text-white font-bold uppercase tracking-widest text-3.25 md:text-sm px-8 md:px-10 py-5 md:py-6 rounded-full hover:bg-[#25D366]/90 transition-all shadow-[0_20px_40pxrgba(37,211,102,0.2)] hover:shadow-[0_25px_50pxrgba(37,211,102,0.3)] hover:-translate-y-1 active:translate-y-0 group-hover:scale-[1.02]"
              >
            ...
            <p className="text-brand-accent/50 text-2.5 uppercase tracking-[0.2em] font-black text-center sm:text-left">
