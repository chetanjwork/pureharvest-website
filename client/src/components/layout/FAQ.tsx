      ...
      <Container className="relative z-10">
        <div className="max-w-3xl mx-auto text-center flex flex-col items-center">
          ...
          >
            ...
            <Link
              href="/faq"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-brand-accent text-white font-black uppercase tracking-widest text-[9px] px-10 py-5 rounded-full hover:bg-brand-accent/90 transition-all hover:scale-105 active:scale-95 shadow-[0_8px_30px_rgba(11,33,71,0.12)] cursor-pointer"
            >
              Explore FAQ Library
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 bg-white border border-black/[0.06] text-brand-accent font-black uppercase tracking-widest text-[9px] px-8 py-[18px] rounded-full hover:border-black/20 hover:bg-black/[0.01] transition-all hover:scale-105 active:scale-95 cursor-pointer"
            >
