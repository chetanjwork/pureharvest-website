  ...
  return (
    <>
      ...
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 flex justify-center pointer-events-none will-change-transform transform-gpu ${isMenuOpen ? 'z-[200]' : 'z-[100]'}`}
      >
        <motion.div 
          layout
          className={`
            ...
            ${isMenuOpen 
              ...
              : scrolled
                ? 'w-auto px-4 py-2 sm:px-5 lg:py-2 bg-white/95 md:bg-white/60 bg-[radial-gradient(120%_120%_at_50%_-20%,rgba(255,255,255,0.95)_0%,rgba(255,255,255,0.2)_100%)] md:backdrop-blur-md border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.12)] rounded-full gap-4 sm:gap-6'
        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex-1 overflow-y-auto px-5 space-y-4">
              ...
              <div className="bg-white rounded-[22px] divide-y divide-gray-100 overflow-hidden border border-black/[0.03] shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                {navLinks.map((link, i) => (
                  <motion.button
                    ...
                    onClick={() => scrollTo(link.id)}
                    className="w-full flex items-center justify-between px-5 py-3.5 active:bg-gray-50 transition-colors group"
                  >
                    <div className="flex flex-col items-start gap-0.5">
                      <span className="text-[16px] font-bold tracking-[-0.01em] text-black group-active:text-brand-secondary transition-colors">
                        {link.name}
                      </span>
              ...
              <div className="bg-white rounded-[22px] divide-y divide-gray-100 overflow-hidden border border-black/[0.03] shadow-[0_2px_10px_rgba(0,0,0,0.02)]">
                <a href="tel:+918149174975" className="w-full flex items-center gap-4 p-5 active:bg-gray-50 transition-colors">
                  <div className="w-[38px] h-[38px] rounded-full bg-[#007AFF]/10 flex items-center justify-center text-[#007AFF]">
                    <Phone size={16} strokeWidth={2.5} />
                  </div>
                  <div className="flex flex-col">
                    <span className="text-[9px] font-black text-[#8E8E93] uppercase tracking-[0.2em] mb-0.5">Direct Call</span>
                    <span className="text-[16px] font-black text-black tracking-tight">+91 81491 74975</span>
                  </div>
                </a>
                <div className="px-5 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-[34px] h-[34px] rounded-full bg-[#F2F2F7] flex items-center justify-center text-[#8E8E93]">
                      <Globe size={14} strokeWidth={2.5} />
                    </div>
                    <span className="text-[14px] font-bold text-black">Social Hub</span>
                  </div>
                  <div className="flex gap-3">
                    <a href="https://wa.me/918149174975" target="_blank" rel="noopener noreferrer" className="w-[34px] h-[34px] flex items-center justify-center rounded-full bg-[#25D366]/10 text-[#25D366] active:scale-95 transition-transform">
                      <MessageCircle size={16} strokeWidth={2} />
                    </a>
                    <a href="https://www.instagram.com/pure_harvest.enterprise" target="_blank" rel="noopener noreferrer" className="w-[34px] h-[34px] flex items-center justify-center rounded-full bg-[#E1306C]/10 text-[#E1306C] active:scale-95 transition-transform">
            ...
            <div className="px-5 mt-auto pt-6 pb-2 relative z-50">
              <button
                onClick={() => scrollTo('onboarding')}
                className="w-full bg-[#0B2147] text-white py-4 rounded-full text-[13px] font-black uppercase tracking-[0.2em] shadow-lg active:scale-[0.98] transition-all flex items-center justify-center gap-3 relative overflow-hidden group"
              >
